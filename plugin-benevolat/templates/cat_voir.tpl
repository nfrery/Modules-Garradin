...
{include file="%s/templates/_menu_categorie.tpl"|args:$plugin_root current="categorie"}

{form_errors}

<dl class="describe">
    <dt><label>Intitulé</label></dt>
    <dd>{$categorie.nom}</dd>
    <dt><label>Taux horaire</label></dt>
    <dd>{$categorie.taux_horaire} €/h</dd>
