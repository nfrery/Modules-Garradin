...
<p class="help">
    Les rappels automatiques sont envoyés aux membres disposant d'un numéro de téléphone portable
    ...
    <table class="list">
        ...
        {foreach from=$liste item="rappel"}
            <tr>
                ...
                <td class="actions">
                    <a class="icn" href="{plugin_url}rappel_modifier.php?id={$rappel.id}" title="Modifier">✎</a>
                    <a class="icn" href="{plugin_url}rappel_supprimer.php?id={$rappel.id}" title="Supprimer">✘</a>
                </td>
            </tr>
        {/foreach}
        </tbody>
